...
const Test = component$(() => {
  ...
  return (
    ...
    <TextInput value={textValue} data-x="x" type="text" renderSize="sm" labelText="Label" hideLabel helperText='Helper text' inline invalid 
      invalidText='Invalid text' readOnly warn warnText='Warning text' enableCounter maxCount={10} onChange$={$((event: QwikChangeEvent<HTMLInputElement>) => alert(`Length: ${event.target.value.length}`))} />
  </CarbonRoot>);
});
