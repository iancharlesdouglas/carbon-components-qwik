...
describe('Button', () => {
  ...
  it('supports a custom CSS class', async () => {
    ...
    await render(
      <CarbonRoot>
        <Button class={customClass}>Custom text</Button>
      </CarbonRoot>
    );
  ...
  it('sets the appropriate CSS class for the stipulated kind', async () => {
    ...
    kinds.forEach(async (kind: ButtonKind) => {
      ...
      await render(
        <CarbonRoot>
          <Button kind={kind}>{kind} Button</Button>
        </CarbonRoot>
      );
  ...
  it('sets the appropriate CSS class/es if isExpressive is stipulated, including suppression of certain sizes', async () => {
    ...
    await render(
      <CarbonRoot>
        <Button id="expr" isExpressive>
          Expressive
        </Button>
        <Button id="sm" isExpressive size="sm">
          Small
        </Button>
        <Button id="md" isExpressive size="md">
          Small
        </Button>
        <Button id="lg" isExpressive size="lg">
          Small
        </Button>
      </CarbonRoot>
    );
  ...
  it('renders an anchor if the href attribute has been set', async () => {
    ...
    await render(
      <CarbonRoot>
        <Button href={expectedHref}>Link</Button>
      </CarbonRoot>
    );
